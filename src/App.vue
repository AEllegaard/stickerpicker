...
<template>
  <div id="root">
    <div style="position: fixed; top: 0; left: 0; z-index: 100; padding: 12px;">
      <button class="btn-action" @click="resetStickerPicker" style="padding: 0; border-radius: 50%; width:44px; height:44px; display:flex; align-items:center; justify-content:center; background: none; box-shadow: none; border: none;">
        <img src="./assets/redo.svg" alt="Reset" width="32" height="32" style="display:block;" />
      </button>
    </div>
