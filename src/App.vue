...
<template>
  <div id="root">
    <div style="position: fixed; top: 0; left: 0; z-index: 100; padding: 12px;">
      <button class="btn-action" @click="resetSticker" style="padding: 0; border-radius: 50%; width:44px; height:44px; display:flex; align-items:left; justify-content:end; background: none; box-shadow: none; border: none;">
